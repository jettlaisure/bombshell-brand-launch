        ...
        {!exiting && (
          ...
          >
            ...
            <video
              ...
              muted
              playsInline
              className="absolute top-0 left-0 w-full h-[115%] md:h-full object-cover"
              style={{
            ...
            <motion.div
              ...
              className="relative z-10 flex flex-col items-center gap-3 md:gap-5 px-6 w-full max-w-md md:max-w-lg flex-1 justify-end pb-8 md:justify-center md:pb-6 md:-mt-8"
            >
               <h1
