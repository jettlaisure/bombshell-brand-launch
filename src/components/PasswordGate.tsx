      ...
      <AnimatePresence>
        {!exiting && (
          <motion.div
            ...
            className="fixed inset-x-0 z-[100] flex w-full flex-col items-center justify-center overflow-hidden bg-foreground"
            style={{ top: "calc(env(safe-area-inset-top) * -1)", bottom: "calc(env(safe-area-inset-bottom) * -1)" }}
          >
            <video
              autoPlay
              loop
            ...
            {/* Logo above form */}
            <div className="relative z-10 flex justify-center -mb-4 md:-mb-6 -mt-[20vh] md:-mt-[20vh]">
              <img src={logoImg} alt="Bombshell" className="w-32 md:w-72" />
            </div>
