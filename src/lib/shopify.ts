...
const mockProducts: Product[] = [
  {
    ...
    variants: [
      { id: "v1-s", title: "S", price: "120.00", available: true, selectedOptions: [{ name: "Size", value: "S" }] },
      { id: "v1-m", title: "M", price: "120.00", available: true, selectedOptions: [{ name: "Size", value: "M" }] },
      { id: "v1-l", title: "L", price: "120.00", available: true, selectedOptions: [{ name: "Size", value: "L" }] },
      { id: "v1-xl", title: "XL", price: "120.00", available: true, selectedOptions: [{ name: "Size", value: "XL" }] },
    ],
    productType: "Hoodies",
  ...
  },
  {
    ...
    variants: [
      { id: "v2-s", title: "S", price: "120.00", available: true, selectedOptions: [{ name: "Size", value: "S" }] },
      { id: "v2-m", title: "M", price: "120.00", available: true, selectedOptions: [{ name: "Size", value: "M" }] },
      { id: "v2-l", title: "L", price: "120.00", available: true, selectedOptions: [{ name: "Size", value: "L" }] },
      { id: "v2-xl", title: "XL", price: "120.00", available: true, selectedOptions: [{ name: "Size", value: "XL" }] },
    ],
    productType: "Hoodies",
    tags: ["hoodie", "heavyweight", "new", "cropped"],
    vendor: "Bombshell",
  ...
  },
  {
    ...
    variants: [
      { id: "v3-s", title: "S", price: "120.00", available: true, selectedOptions: [{ name: "Size", value: "S" }] },
      { id: "v3-m", title: "M", price: "120.00", available: true, selectedOptions: [{ name: "Size", value: "M" }] },
      { id: "v3-l", title: "L", price: "120.00", available: true, selectedOptions: [{ name: "Size", value: "L" }] },
      { id: "v3-xl", title: "XL", price: "120.00", available: true, selectedOptions: [{ name: "Size", value: "XL" }] },
    ],
    productType: "Hoodies",
    tags: ["hoodie", "heavyweight", "new", "cropped"],
    vendor: "Bombshell",
